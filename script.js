...
function displayScripts(scripts) {
    ...
    scripts.forEach((script) => {
        ...
        const fallbackImage = "https://files.catbox.moe/pclq02.jpg";
...
function displayDetails(script) {
    ...
    const gameImage = script.game?.imageUrl
        ...
        : "https://files.catbox.moe/pclq02.jpg";
        ...
        <div class="minimal-details-card">
            <div class="details-header">
                <div class="header-image">
                    <img src="${gameImage}" alt="${gameName}" onerror="this.src='https://files.catbox.moe/pclq02.jpg';">
                </div>
